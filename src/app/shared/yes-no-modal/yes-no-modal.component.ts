...
@Component({
  ...
  template: `
    ...
    <div class="modal-footer border-0">
      <button type="button" class="btn btn-danger-outline" (click)="activeModal.close(false)">No</button>
      <button type="button" class="btn btn-main-outline" (click)="activeModal.close(true)">Yes</button>
    </div>
  `
})
